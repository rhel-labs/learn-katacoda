...
Now, let's open up the sqlcmd shell prompt connected to the **testDB** database. testDB should be created by Ansible playbook, and the sa password credentials is the password setup in the playbook variables. 
